...
export default function BranchesScreen() {
      ...
      >
        <View style={styles.branchContent}>
          <View style={styles.branchIcon}>
            <IconSymbol name="building.2.fill" size={32} color={isDark ? '#64D2FF' : '#0a7ea4'} />
          </View>
          ...
          <View style={styles.branchActions}>
            ...
            >
              <IconSymbol name="pencil" size={20} color={isDark ? '#FFFFFF' : '#11181C'} />
            </View>
            <View 
              style={styles.actionButton}
              onTouchEnd={(e) => {
  ...
  const renderEmptyState = () => (
    <Animated.View entering={FadeIn} style={styles.emptyContainer}>
      <IconSymbol name="building.2" size={64} color={isDark ? 'rgba(255,255,255,0.3)' : 'rgba(0,0,0,0.2)'} />
      ...
      <AnimatedFlatList
        ...
        ListHeaderComponent={
          <View style={styles.header}>
            <ThemedText style={styles.headerTitle}>Your Branches</ThemedText>
