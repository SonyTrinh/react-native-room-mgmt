...
export default function BranchDetailScreen() {
          ...
          <View style={styles.roomContent}>
            <View style={styles.roomHeader}>
              <View style={styles.roomIcon}>
                <IconSymbol name="bed.double.fill" size={28} color={isDark ? '#64D2FF' : '#0a7ea4'} />
              </View>
            ...
            <View style={styles.roomDetails}>
              <View style={styles.detailItem}>
                <IconSymbol name="bolt.fill" size={16} color={isDark ? '#FFD60A' : '#FF9500'} />
                <ThemedText style={styles.detailText}>
                  ${item.monthlyRent || 0}/month
                </ThemedText>
              </View>
              <View style={styles.detailItem}>
                <IconSymbol name="phone.fill" size={16} color={isDark ? '#30D158' : '#34C759'} />
                <ThemedText style={styles.detailText}>
  ...
  const renderEmptyState = () => (
    <Animated.View entering={FadeIn} style={styles.emptyContainer}>
      <IconSymbol name="bed.double" size={64} color={isDark ? 'rgba(255,255,255,0.3)' : 'rgba(0,0,0,0.2)'} />
      ...
      <AnimatedFlatList
        ...
        ListHeaderComponent={
          <View style={styles.header}>
            <ThemedText style={styles.headerTitle}>{branch.name}</ThemedText>
            <ThemedText style={styles.headerAddress}>{branch.address}</ThemedText>
